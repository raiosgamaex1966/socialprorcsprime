...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-2xl border-0 bg-card text-card-foreground shadow-[0_1px_3px_0_hsl(0_0%_0%/0.06),0_4px_12px_0_hsl(0_0%_0%/0.04)]", className)} {...props} />
));
